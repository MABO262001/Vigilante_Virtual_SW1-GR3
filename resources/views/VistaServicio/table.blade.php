    ...
    <table class="w-full border-collapse table-fixed">
        <thead>
            <tr class="bg-blue-300">
                ...
                <th class="w-4/12 py-3 border border-black">Descripción</th>
                <th class="w-2/12 py-3 border border-black">Fecha</th>
                <th class="w-1/12 py-3 border border-black">Precio</th>
                ...
                @foreach ($servicios as $servicio)
                    <tr class="{{ $loop->even ? 'bg-gray-100' : 'bg-white' }} transition-colors duration-300 hover:bg-blue-400">
                        ...
                        <td class="py-2 px-4 text-center border border-gray-400">
                            <a href="{{ route('Servicio.edit', $servicio->id) }}" class="text-blue-500 hover:text-blue-700 font-bold mr-3 transition duration-300 transform hover:scale-110">
                            ...
                            <a href="{{ route('Servicio.show', $servicio->id) }}" class="text-gray-500 hover:text-blue-500 font-bold transition duration-300 transform hover:scale-110">
