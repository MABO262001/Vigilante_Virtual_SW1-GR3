@extends('Panza')
@section('Panza')
    <form id="userForm" action="{{ route('Usuario.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="mb-4">
            ...
            <input type="file" name="profile_photo_path" id="profile_photo_path" class="hidden rounded-full"
            ...
            <label for="profile_photo_path"
                ...
                <img id="preview_image"
                    class="hidden absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-32 object-cover rounded-full"
                    alt="">
            </label>
        </div>
        <div class="mb-4">
        ...
        <div id="cantidad_usuarios_container" class="mb-4 hidden">
            ...
            <input type="number" name="cantidad_usuarios" id="cantidad_usuarios" placeholder="Cantidad de Usuarios"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>
    ...
    <script>
        ...
        // Función para mostrar u ocultar el campo "Cantidad de Usuarios"
